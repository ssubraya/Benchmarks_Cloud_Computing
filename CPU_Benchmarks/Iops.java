...
public class Iops extends Thread {

	
static ArrayList<Double> a= new ArrayList<>();
static int count=0;
static float sum = 0;
	private static class MessageLoop extends  Iops   {
...
t.start();
 ...
 double end_time = System.currentTimeMillis(); //end time
                                          double total_time =  (end_time - startTime)/1000;
                                          System.out.println(total_time);
                                          double f=(double) (((1000000001 / (total_time))*6)/1000000000);
System.out.println("Iops for thread 1 =" + f);
...
double startTime = System.currentTimeMillis();//start time
 ...
 double end_time = System.currentTimeMillis(); //end time
                                          double total_time =  (end_time - startTime)/1000;
                                          System.out.println(total_time);
                                          double f=(double) (((1000000001 / (total_time))*6*2)/1000000000);
System.out.println("GIops for two threads  =" + f);
//for(double e:a){
  //                                        sum+=e;
    //                                      System.out.println(count);
      //                                    System.out.println(sum);
...
double startTime = System.currentTimeMillis();//start time
 ...
 double end_time = System.currentTimeMillis(); //end time
                                          double total_time =  (end_time - startTime)/1000;
                                          System.out.println(total_time);
                                          double f=(double) (((1000000001 / (total_time))*6*4)/1000000000);
System.out.println("GIops for three threads =" + f);
//for(double e:a){
  //                                        sum+=e;
    //                                      System.out.println(count);
      //                                    System.out.println(sum);
