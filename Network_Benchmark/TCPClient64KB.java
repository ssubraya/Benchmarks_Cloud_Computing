...
public class TCPClient64KB extends Thread {
	static int thread_count;	
	static int KB=64*1024;
	private static class MessageLoop  extends TCPClient64KB  {
...
//			String name = args[0];
			...
			try {
				String readerInput;
				FileReader fs=new FileReader("64kb.txt");// reading from the file
	...
	private static class MessLoop  extends TCPClient64KB  {
		...
		public static void main (String[] args) throws UnknownHostException, IOException, InterruptedException {
	    	...
	    	if(thread_count == 1)
	    	{
	    		...
	    		double RTT= total_time/thread_count;   		//calculates the return time
	       		...
	       		System.out.println("Throughput = "+((8*KB/RTT)/(1))+" Mb/sec");
